...
instantiating code like a workspace or a different widget.</td></tr><tr valign="top"><td>setupTextListener</td><td>function</td><td>function () <br><br>Listen for incoming texts so we can trigger the Texterator as well
...
Zipwhip Receive Text widget. So make sure that widget is loaded.</td></tr><tr valign="top"><td>comPort</td><td>string</td><td>"com14"<br><br>Make sure to update the serial port that the arduino/nodemcu device is on that takes commands.</td></tr><tr valign="top"><td>moveFwdSlotAndVendBeer</td><td>function</td><td>function () <br><br>Advances lazy susan once and vends beer</td></tr><tr valign="top"><td>onDoneMoveFwdSlotAndVendBeer</td><td>function</td><td>function () <br><br>Called when we see the done cmd come back in over serial.</td></tr><tr valign="top"><td>sendSerial</td><td>function</td><td>function (cmd) </td></tr><tr valign="top"><td>setupSerialPubSub</td><td>function</td><td>function () </td></tr><tr valign="top"><td>lastSerialData</td><td>string</td><td></td></tr><tr valign="top"><td>onRecvSerial</td><td>function</td><td>function (data) </td></tr><tr valign="top"><td>processSerialDataRaw</td><td>function</td><td>function () <br><br>Data does not come in line by line, so we have to queue the incoming characters and
